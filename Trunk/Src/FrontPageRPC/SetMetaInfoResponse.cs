...
{
    public class SetMetaInfoResponse : ResponseBase
    {
        private DocumentCollection _documents;
        private FolderCollection _folders;
        private SetMetaInfoRequest _request;
        private List<ITreeNode> _nodes;
        private Folder _rootFolder = null;

        internal SetMetaInfoResponse(WebClient wc, SetMetaInfoRequest setMetaInfoRequest)
            : base(wc)
        {
            _request = setMetaInfoRequest;
        }
