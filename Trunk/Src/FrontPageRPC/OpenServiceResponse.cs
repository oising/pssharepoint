...
{
    public class OpenServiceResponse : ResponseBase
    {
        public Service Service;
        public string Message = "";

        internal OpenServiceResponse(WebClient wc)
            : base(wc)
        {
        }
        ...
        internal override void ReadResponse(Stream response, long responseLength)
        {
            ...
            this.Service = new Service(base._nav.SelectSingleNode("//ul[@name='service']"));
        }
    }
}
