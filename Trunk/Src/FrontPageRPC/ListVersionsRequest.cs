...
{
    public class ListVersionsRequest : RequestBase
    {
        Document _document;
        ...
        public ListVersionsRequest(Document document)
        {
            Document = document;
        }

        /// <summary>
        /// Gets or sets the document to retrieve metadata for.
        /// </summary>
        public Document Document
        {
            ...
            { 
                _document = value;
                WebUrl = _document.WebUrl;
            }
        }

        public override string MethodName
        {
            get { return "list versions"; }
        }
