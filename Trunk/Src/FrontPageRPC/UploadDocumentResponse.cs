...
namespace HubKey.Net.FrontPageRPC
{
    public class UploadDocumentResponse : ResponseBase
    {
        ...
        UploadDocumentRequest _request;

        internal UploadDocumentResponse(WebClient wc, UploadDocumentRequest uploadRequest)
            : base(wc)
        {
        ...
        /// <summary>
        /// Gets the document reponse from the server.
        /// </summary>
