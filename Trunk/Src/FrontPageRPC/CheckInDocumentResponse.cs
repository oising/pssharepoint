...
{
    public class CheckInDocumentResponse : ResponseBase
    {
        Document _document;
        CheckInDocumentRequest _checkinDocumentRequest;

        internal CheckInDocumentResponse(WebClient wc, CheckInDocumentRequest checkinDocumentRequest)
            : base(wc)
        {
            _checkinDocumentRequest = checkinDocumentRequest;
        }

        /// <summary>
        /// Gets the document metainfo for the checked in document.
        /// </summary>
        ...
        internal override void ReadResponse(Stream response, long responseLength)
        {
            ...
            _document = _checkinDocumentRequest.Document;
