...
{
    public class UnCheckOutDocumentResponse : ResponseBase
    {
        Document _document;
        UnCheckOutDocumentRequest _UnCheckOutDocumentRequest;

        internal UnCheckOutDocumentResponse(WebClient wc, UnCheckOutDocumentRequest UnCheckOutDocumentRequest)
            : base(wc)
        {
            _UnCheckOutDocumentRequest = UnCheckOutDocumentRequest;
        }
        ...
        internal override void ReadResponse(Stream response, long responseLength)
        {
            ...
            _document = _UnCheckOutDocumentRequest.Document;
