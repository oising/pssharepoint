...
namespace HubKey.Net.FrontPageRPC
{
    public class Service
    {
        ...
        /// <summary>
        /// Gets or sets the service meta-information.
        /// </summary>
        ...
        internal Service(XPathNavigator rpcResponseNav)
        {
            _name = rpcResponseNav.SelectSingleNode("li[@name='service_name']").Value;
            _metaInfo = new MetaInfoCollection(rpcResponseNav.SelectSingleNode("ul[@name='meta_info']"));
        }
    }
}
